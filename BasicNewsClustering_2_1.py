...
if __name__ == "__main__":
    folder = "CorpusTXTNoticiasPractica1819Traducidos"
    ...
    for file in listing:
        if file.endswith(".txt"):
            ...
            f.close()
            print("Texto: ", text)
            ## Tokenizar texto en frases para su procesamiento
            sentences = nltk.sent_tokenize(text)
            tokenized_sentences = [nltk.word_tokenize(sentence) for sentence in sentences]

            # ## PRUEBA 1. LEMATIZACION:
            # ## INICIO PRUEBA 1
            ...
            # ## hacemos que tokens_wo_punctuation apunte a tokens
